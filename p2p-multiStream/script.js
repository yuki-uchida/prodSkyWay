...
(async function main() {
  ...
  const remoteVideo = document.getElementById('js-remote-stream-video');
  const remoteDisp = document.getElementById('js-remote-stream-disp');
  const remoteStreams = document.getElementById('js-remote-stream');
  ...
  callTrigger.addEventListener('click', () => {
    ...
    mediaConnection.on('stream', async stream => {
      ...
      stream.getTracks().forEach( async (videoTrack, index) => {
        ...
        newVideo.setAttribute('data-peer-id', index);
